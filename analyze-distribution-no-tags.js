...
// 메인 분석
console.log('=== 덱 매칭 분포 분석 (태그: 상관없음만) ===\n');
...
console.log(`조건: 태그 선택 = "상관없음"만 고려\n`);
...
console.log(`=== 샘플링 결과 (${sampleSize.toLocaleString()}개, 태그: 상관없음) ===\n`);
